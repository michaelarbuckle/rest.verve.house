...
*/
	...
	*/
	...
	@RequestMapping(value = "/structuresForUser", method = RequestMethod.GET)
	String index2(Model model, @RequestParam Optional<Point> location, @RequestParam Optional<Distance> distance,
			Pageable pageable) {
		
		return "structuresForUser";
	}
	
	@RequestMapping(value = "/findZonesForStructure", method = RequestMethod.GET)
	String index(Model model, @RequestParam Optional<Point> location, @RequestParam Optional<Distance> distance,
			Pageable pageable) {
/*
		Point point = location.orElse(KNOWN_LOCATIONS.get("Timesquare NY"));
